...
const isWalletDisconnected = (wallet) =>
  !!_includes(["disconnected", "error"], getWalletConnectionStatus(wallet));

const isWalletConnecting = (wallet) =>
  getWalletConnectionStatus(wallet) === "connecting";

const isWalletConnected = (wallet) =>
  getWalletConnectionStatus(wallet) === "connected";

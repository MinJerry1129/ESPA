    ...
    >
      <div className="flex flex-col md:flex-row w-full mb-20 px-20 md:px-0 mt-10 md:mt-0">
        ...
        <div className="w-full md:w-12/12">
          ...
          <p className={`text-4xl mt-10 text-center`}>META LEADERBOARD</p>
          <div className="flex justify-center flex-col md:flex-row mb-10 md:mb-0">
            <div className="flex justify-center flex-row md:flex-col mb-10 md:mb-0">
          ...
          <div className="flex justify-center flex-col md:flex-row mb-10 md:mb-0">
            {tier4.map(item => (
              <div className="flex justify-center flex-row md:flex-col mb-10 md:mb-0" key={item}>
                <img src="/leaderboard/tier4.png" width="400" />
                <div className="bg-white text-black w-60 text-center md:ml-20 p-2 h-10 items-center flex">
...
export default MetaLeaderboard;

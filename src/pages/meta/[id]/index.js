...
import CrewList from '@components/profile/CrewList'
import DigiIDList from '@components/profile/DigiIDList'
  ...
  return (
    <div className={styles.profileWrapper}>
      <div className={styles.leftSideWrapper}>
        <div className={[styles.title, styles.metaTitle].join(' ')}>
          META ID
        </div>
        <WalletAddress address={'0x2b7955194c087DE552772D395756202d69549226'}/>
        <ProfileCard className='self-start mt-5' />
        <DigiIDList className='mt-10'
          idList={[
            {
              frameType: 0,
              gameName: 'Sheriff'
        ...
        />
        <CrewList className='mt-10' />
        <div className='flex flex-row mt-10'>
          <GradientButton type={0}>
            MOD META id
          </GradientButton>
          <GradientButton type={0}>
            CHOOSE CREW
          </GradientButton>
          <GradientButton type={1}>
            GLOBAL CLEAR conditions
          </GradientButton>
          <GradientButton type={2}>
            collect skins
          </GradientButton>
        </div>
